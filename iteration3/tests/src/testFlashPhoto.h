 ...
 * 
 * The testFlashPhoto class.  This class sets up the GUI and the display pixelBuffer.
 * 
...
#ifndef testFlashPhoto_H
#define testFlashPhoto_H
...
class testFlashPhoto : public BaseGfxApp
{
public:

	testFlashPhoto(int argc, char* argv[], int width, int height, ColorData backgroundColor);
	virtual ~testFlashPhoto();
...
private:
	 ...
	 * testFlashPhoto specific functions
	 */
	void initGlui();
