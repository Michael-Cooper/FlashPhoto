...
void Tool::applyToBufferStamp(int toolX, int toolY, ColorData toolColor, PixelBuffer* buffer, PixelBuffer* stamp){}

void Tool::applyToBufferMouseDown(int toolX, int toolY, ColorData toolColor, PixelBuffer* buffer){}
